...
public class Liquid : MonoBehaviour {
        ...
        if (checkreciver)
        {
            ...
            if (GrabBool)
            {
                ...
                if (reflect() != null && reflect().GetComponent<Base>())
                {
                    ...
                    reflect().GetComponent<Base>().ChangeColor(2);
                    ...
                    switch (reflect().GetComponent<Base>().Type)
                    {
                        case 2:
                            ...
                            if (Input.GetMouseButtonDown(0)) // mausis dawerisas obieqti motavsdeba 
                            {
                                ...
                                mycamera.GetComponent<Raycast>().BlockBool = false;
                                GrabBool = false;
                            }
    ...
    public void grab()
    {
        ...
        mycamera.GetComponent<Raycast>().locfind = gameObject;
        mycamera.GetComponent<Raycast>().BlockBool = true;
        ...
        else if(gameObject.GetComponent<Liquid>())
        {
            switch (gameObject.GetComponent<Liquid>().Type)
            {
